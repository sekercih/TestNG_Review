...
public class C01_Review01 {
    //todo
    // 1. TestNG: Junit uzerinden Next Generation olarak Java ile otomasyon yapmak uzere hazirlanmistir.
    // 2. Daha fazla notasyon ile tester'larin testleri daha iyi control edebilmesine imkan verir.
    // 3. @priority ile istedigimiz testleri istedigimiz siralama ile calistirabiliriz
    // 4. Raporlar yapmamiza imkan verir
    // 5. Xml dosya ile toplu calistirma, parallel calistirma ve cross borowsing yapmamiza imkan tanir
    ...
    // - selectByIndex()
    // - selectByValue()
    // -bunların dışında select ile kullanabileceğimiz methotlardan bazıları
    // -getFirstSelectdOption : en son secilen option u bize verir
    // -getOptions :tüm optionları bize webelementlerden oluşan bir liste olarak verir.
